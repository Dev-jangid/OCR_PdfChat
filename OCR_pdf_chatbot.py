    ...
    def process_pdf(self, file_bytes):
        with st.spinner("Analyzing document..."):
            ...
            if self._needs_ocr(texts, len(doc)):
                ...
                texts = self._run_ocr(file_bytes)
                doc.close()  # Close the original doc
                doc = fitz.open(stream=file_bytes, filetype="pdf")  # Reopen for metadata
...
def main():
    ...
    st.caption("Intelligent document analysis for text-based and scanned PDFs")
    ...
    if prompt := st.chat_input("Ask about the document..."):
        ...
        with st.spinner("Analyzing request..."):
            ...
            if not response and data["texts"]:
                ...
                response = "No text content found in document"
